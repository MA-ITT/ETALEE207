...
🥀<u>**تخطي محدد:**</u>
/ skip or / cskip [الرقم (مثال: 3)] - يتخطى الموسيقى إلى رقم محدد في قائمة الانتظار. مثال: سيتخطى / skip 3 الموسيقى إلى الموسيقى في قائمة الانتظار الثالثة ويتجاهل الموسيقى 1 و 2 في قائمة الانتظار.
...
فرض أوامر التشغيل = playforce , vplayforce , cplayforce
...
📣**<u>عمل اذاعه في البوت:</u>**
/broadcast اكتب الامر وجنبه الرساله او اعمل ريب علي الرساله للاذاعه وهيتم عمل اذاعه محوله لو عملت ريب.
